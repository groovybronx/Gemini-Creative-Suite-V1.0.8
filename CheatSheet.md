...
- [REST Resource: v1beta.corpora.documents](https://ai.google.dev/api/all-methods#v1beta.corpora.documents)
- [REST Resource: v1beta.corpora.documents.chunks](https://ai.google.dev/api/all-methods#v1beta.corpora.documents.chunks)
...
- [REST Resource: v1beta.ragStores](https://ai.google.dev/api/all-methods#v1beta.ragStores)
- [REST Resource: v1beta.ragStores.documents](https://ai.google.dev/api/all-methods#v1beta.ragStores.documents)
- [REST Resource: v1beta.ragStores.operations](https://ai.google.dev/api/all-methods#v1beta.ragStores.operations)
- [REST Resource: v1beta.ragStores.upload.operations](https://ai.google.dev/api/all-methods#v1beta.ragStores.upload.operations)
...
|                                                                                                                                          Methods                                                                                                                                          ||
|---------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [upload](https://ai.google.dev/api/files#v1beta.media.upload) | `POST /v1beta/{ragStoreName=ragStores/*}:uploadToRagStore` `POST /upload/v1beta/{ragStoreName=ragStores/*}:uploadToRagStore` Uploads data to a ragStore, preprocesses and chunks before storing it in a RagStore Document. |
